...
- Las veinte familias tipográficas del catálogo se sirven como WOFF2 locales desde el mismo despliegue; el HUD, el Lab y los consumidores no dependen de un CDN ni de fuentes del sistema.
